...
const Series1 = ( props ) => {
    ...
    const products = [
        {Name : "George Thomas Parker", Image: georgethomasparker, Description : "Recomposed surplus shearling patched parker dress. Drawstring removable hood with brass eyelets in chocolate brown with tonal cotton viscose lining", Kind:"One of a Kind" ,Price : 3600},
        {Name : "Dot Dress", Image: dotdress, Description : "Recomposed viscose jersey dot print double dress", Kind:"One of a Kind" ,Price : 250},
        {Name : "Blouse Apron", Image: blouseapron, Description : "Recomposed Pink Polyester pleated Blouse Apron", Kind:"One of a Kind" ,Price : 250},
        ...
        {Name : "Billy Skirt", Image : billyskirt, Description : "Deadstock Polka dot and blackchiffon vest dress, with recomposed removable elastic waistband for skirt", Kind:"One of a Kind" ,Price : 350},
        ...
        {Name : "2D Corset Tank Top", Image : cosettanktop, Description: "Recomposed boneless jersey and lace Corsetaplique jerseytank top.", Kind:"One of a Kind" ,Price : 200},
        {Name : "Spanks Jeans", Image : spanksjeans, Description : "Recomposed XXXI denimjeans, withsnap fastened under stretch short, multistylewear", Kind:"One of a Kind" ,Price : 250},
        ...
        {Name : "Carpet Shift Dress", Image : carpetshiftdress, Description : "Deadstock faux fur shift dress with zip side closure", Kind:"One of a Kind" ,Price : 300},
        ...
        {Name : "Old Money Dress", Image : oldmoneydress, Description : "Removable deadstock Mongolian shearling panelled stretch midi dress, with extend bra back closure", Kind:"One of a Kind" ,Price : 2000},
        {Name : "Suede Body", Image : suedebody, Description : "Multi tone boned short body suit in deadstock goat suede", Kind:"One of a Kind" ,Price : 2000},
